...
class TelecomDetector:
    ...
    def detect_objects(self, img: np.ndarray, conf_threshold: float = 0.05) -> list[dict]:
        ...
        # ── DPI-BASED THRESHOLDS (100% Empirically Calculated) ──
        if self.dpi == 300:
            node_thresh = 0.26
            le_thresh = 0.23
            dual_amp_thresh = 0.16
            amp_3way_thresh = 0.17
            equalizer_thresh = 0.06
            splice_thresh = 0.12
            terminator_thresh = 0.16
            ps_thresh = 0.77
            tap_thresh = 0.36
            booster_thresh = 0.15
            int_dc_thresh = 0.53
            dc_thresh = 0.60
            int_2way_thresh = 0.10
            splitter_3way_thresh = 0.06
            splitter_2way_thresh = 0.74
        elif self.dpi == 600:
            node_thresh = 0.10
            le_thresh = 0.17
            dual_amp_thresh = 0.10
            amp_3way_thresh = 0.06
            equalizer_thresh = 0.06
            splice_thresh = 0.11
            terminator_thresh = 0.47
            ps_thresh = 0.54
            tap_thresh = 0.29
            booster_thresh = 0.15
            int_dc_thresh = 0.07
            dc_thresh = 0.15
            int_2way_thresh = 0.10
            splitter_3way_thresh = 0.12
            splitter_2way_thresh = 0.34
        elif self.dpi == 800:
            node_thresh = 0.10
            le_thresh = 0.20
            dual_amp_thresh = 0.10
            amp_3way_thresh = 0.08
            equalizer_thresh = 0.07
            splice_thresh = 0.09
            terminator_thresh = 0.31
            ps_thresh = 0.50
            tap_thresh = 0.41
            booster_thresh = 0.15
            int_dc_thresh = 0.58
            dc_thresh = 0.34
            int_2way_thresh = 0.10
            splitter_3way_thresh = 0.18
            splitter_2way_thresh = 0.61
        else:
            node_thresh = 0.26
            le_thresh = 0.23
            dual_amp_thresh = 0.16
